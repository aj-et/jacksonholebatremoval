        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto px-6 text-white">
          <div className="space-y-8">
            ...
            <h1 className="text-5xl md:text-7xl font-bold leading-tight">
              <span className="block">Professional Bat Removal</span>
            ...
            <p className="text-xl md:text-2xl font-light leading-relaxed max-w-3xl mx-auto text-white/90">
              Safe, humane, and effective bat exclusion services. We specialize in complete bat removal, guano cleanup, and long-term prevention for residential and commercial properties.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-8 pt-8">
              {[
                ...
                { icon: "🏆", text: "Licensed Specialists" }
              ].map((item, index) => (
