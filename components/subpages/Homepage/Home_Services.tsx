  ...
  const services = [
      {
        ...
        text: "Comprehensive property assessment to identify bat activity, entry points, and species determination throughout Wyoming.",
        img: "/images/bat-inspection.webp",
        icon: "🔍",
        features: ["Complete property assessment", "Entry point identification", "Species determination", "Damage evaluation"]
      },
      {
        title: "Humane Exclusion", 
        text: "Safe, effective removal and permanent sealing using proven methods that keep bats out while protecting wildlife.",
        img: "/images/bat-exclusion.webp", 
        icon: "🏠",
        features: ["Humane removal methods", "Professional sealing", "Prevention barriers", "Long-term solutions"]
      },
      {
        title: "Complete Sanitization",
        text: "Professional cleanup of bat droppings, contaminated insulation, and full attic restoration services.",
        img: "/images/guano-cleanup.webp",
        icon: "🧽", 
        features: ["Guano removal", "Attic restoration", "Odor elimination", "Health-safe cleanup"]
      },
    ]
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16 space-y-6">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Comprehensive bat removal solutions for Wyoming properties
            </p>
